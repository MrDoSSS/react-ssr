...
var URLSafeBase64__default = /*#__PURE__*/_interopDefaultLegacy(URLSafeBase64);
...
var App = function App(props) {
  ...
  var PageComponent = children;
  return /*#__PURE__*/React__default['default'].createElement(PageComponent, rest);
};
...
var Document = /*#__PURE__*/function (_React$Component2) {
  inherits(Document, _React$Component2);
...
var endsWith_1 = function (it) {
  ...
  return typeof it === 'string' || it === StringPrototype$1
    || (it instanceof String && own === StringPrototype$1.endsWith) ? endsWith : own;
};
...
var existsSync = function existsSync(f) {
  try {
    fs__default['default'].accessSync(f, fs__default['default'].constants.F_OK);
    return true;
  } catch (_) {
    return false;
  }
...
var getSsrConfig = function getSsrConfig() {
  ...
  var ssrConfigPath = path__default['default'].join(cwd, 'ssr.config.js');

  if (existsSync(ssrConfigPath)) {
    return assign$4(defaultConfig, require(ssrConfigPath));
  } else {
...
var getPages = /*#__PURE__*/function () {
  var _ref = asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee() {
    var possibles, pages, i, _context, _context2, possible, name;
    ...
    return regenerator.wrap(function _callee$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _context3.next = 2;
            return readdir__default['default'](path__default['default'].join(cwd, ssrConfig.viewsDir));

          case 2:
            possibles = _context3.sent;
            pages = [];
            i = 0;
          ...
          case 5:
            ...
            name = path__default['default'].basename(getPageId(possible, '/'));

            if (!(startsWith$2(_context = name.toLowerCase()).call(_context, '_app') || startsWith$2(_context2 = name.toLowerCase()).call(_context2, '_document'))) {
              _context3.next = 10;
              break;
            }
          ...
          case 10:
            if (endsWith$2(possible).call(possible, '.jsx') || endsWith$2(possible).call(possible, '.tsx')) {
              pages.push(possible);
            }
...
var getPageId = function getPageId(page) {
  ...
  var _page$replace$replace = page.replace(path__default['default'].join(cwd, ssrConfig.viewsDir), '').replace(path__default['default'].extname(page), '').split(path__default['default'].sep),
      _page$replace$replace2 = toArray(_page$replace$replace),
      rest = slice$2(_page$replace$replace2).call(_page$replace$replace2, 1);

  return rest.join(separator);
};
var ignores = ['.*', '*.json', '*.lock', '*.md', '*.txt', '*.yml', 'LICENSE'];

var ignoreDotDir = function ignoreDotDir(file, stats) {
  var _context4;

  return stats.isDirectory() && startsWith$2(_context4 = path__default['default'].basename(file)).call(_context4, '.');
};

var ignoreNodeModules = function ignoreNodeModules(file, stats) {
  return stats.isDirectory() && path__default['default'].basename(file) == 'node_modules';
};

var getCacheablePages = /*#__PURE__*/function () {
    ...
    return regenerator.wrap(function _callee2$(_context6) {
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            return _context6.abrupt("return", readdir__default['default'](cwd, concat$2(_context5 = [ignoreNodeModules, ignoreDotDir]).call(_context5, ignores)));
  ...
  return function getCacheablePages() {
...
require('@babel/register')({
  ...
  plugins: filter$2(_context = ['babel-plugin-react-require', ['babel-plugin-css-modules-transform', {
    'extensions': ['.css', '.scss']
...
var userDocumentPath = path__default['default'].join(cwd$1, ssrConfig.viewsDir, "_document".concat(ext));
...
var userAppPath = path__default['default'].join(cwd$1, ssrConfig.viewsDir, "_app".concat(ext));
var AppComponent;

if (existsSync(userAppPath)) {
  var UserAppComponent = require(userAppPath);
...
var getRenderToStringMethod = /*#__PURE__*/function () {
  var _ref = asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee() {
    var method;
    return regenerator.wrap(function _callee$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.t0 = ssrConfig.id;
            _context2.next = _context2.t0 === 'antd' ? 3 : _context2.t0 === 'emotion' ? 7 : _context2.t0 === 'material-ui' ? 11 : _context2.t0 === 'styled-components' ? 15 : 19;
            break;

          case 3:
            _context2.next = 5;
            return Promise.resolve().then(function () { return require('./antd-0287c2b1.js'); });

          case 5:
            method = _context2.sent["default"];
            return _context2.abrupt("break", 23);

          case 7:
            _context2.next = 9;
            return Promise.resolve().then(function () { return require('./emotion-9cf052ec.js'); });
          ...
          case 11:
            _context2.next = 13;
            return Promise.resolve().then(function () { return require('./material-ui-87fe67d2.js'); });
          ...
          case 15:
            _context2.next = 17;
            return Promise.resolve().then(function () { return require('./styled-components-8680f252.js'); });
          ...
          case 19:
            _context2.next = 21;
            return Promise.resolve().then(function () { return require('./default-e8cd0d23.js'); });
  ...
  return function getRenderToStringMethod() {
    return _ref.apply(this, arguments);
  };
}();

var compressProps = function compressProps(props) {
  var packed = stringify$2(props);

  var compressed = Buffer.from(LZString__default['default'].compressToUint8Array(packed));
  return URLSafeBase64__default['default'].encode(compressed);
};
...
function _render() {
  _render = asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee2(file, props) {
    var pageId, cachePath, Page, html, _context3, _context4, viewPath;

    return regenerator.wrap(function _callee2$(_context5) {
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            pageId = getPageId(file, '_');
            cachePath = path__default['default'].join(cwd$1, ssrConfig.distDir, "".concat(pageId, ".html"));
            ...
            return _context5.abrupt("return", fse__default['default'].readFileSync(cachePath).toString());
          ...
          case 4:
            ...
            _context5.prev = 6;
            _context5.next = 9;
            return getRenderToStringMethod();

          case 9:
            _context5.t0 = _context5.sent;
            html = (0, _context5.t0)( /*#__PURE__*/React__default['default'].createElement(DocumentContext.Provider, {
              value: /*#__PURE__*/React__default['default'].createElement(AppComponent, _extends_1({
                children: Page
              }, props))
            }, /*#__PURE__*/React__default['default'].createElement(DocumentComponent, null)), pageId, compressProps(props));
          ...
          case 14:
            ...
            if (!isProd()) {
              console.log(_context5.t1.stack || _context5.t1);
            }

            return _context5.abrupt("return", isProd() ? '' : _context5.t1.stack || _context5.t1);

          case 18:
            _context5.prev = 18;

            if (isProd() && !existsSync(cachePath)) {
              viewPath = slice$2(_context3 = slash__default['default'](file.replace(path__default['default'].join(cwd$1, ssrConfig.viewsDir), '').replace(ext, ''))).call(_context3, 1);

              if (includes$4(_context4 = ssrConfig.staticViews).call(_context4, viewPath)) {
                fse__default['default'].outputFileSync(cachePath, html);
              }
            }
...
var register = /*#__PURE__*/function () {
  var _ref = asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee2(app) {
    var renderFile, engine;
    return regenerator.wrap(function _callee2$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            renderFile = /*#__PURE__*/function () {
              var _ref2 = asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee(file, options, cb) {
                var cacheablePages, pattern, props, _context;
                  ...
                  while (1) {
                    switch (_context2.prev = _context2.next) {
                      case 0:
                        ...
                        _context2.next = 3;
                        return getCacheablePages();

                      case 3:
                        cacheablePages = _context2.sent;
                        pattern = map$2(cacheablePages).call(cacheablePages, function (page) {
                          return '^' + escaperegexp(page);
                        }).join('|');
                        moduleDetectRegEx = new RegExp(pattern);

                      case 6:
                        options.settings, options.cache, options._locals, props = objectWithoutProperties(options, ["settings", "cache", "_locals"]);
                        _context2.prev = 7;
                        _context2.t0 = cb;
                      ...
                      case 16:
                        ...
                        return _context2.abrupt("return", cb(_context2.t3));

                      case 19:
                        _context2.prev = 19;

                        if (process.env.NODE_ENV !== 'production') {
                          forEach$2(_context = keys$2(require.cache)).call(_context, function (filename) {
            ...
            app.set('views', path__default['default'].join(process.cwd(), ssrConfig.viewsDir));
            ...
            _context3.next = 8;
            return Promise.resolve().then(function () { return require('./production-4febe7a9.js'); });

          case 8:
            _context3.next = 10;
            return _context3.sent["default"](app);
          ...
          case 12:
            _context3.next = 14;
            return Promise.resolve().then(function () { return require('./development-b39a1c28.js'); });
...
exports.arrayWithHoles = arrayWithHoles;
...
exports.keys = keys$2;
exports.nonIterableRest = nonIterableRest;
...
exports.unsupportedIterableToArray = unsupportedIterableToArray;
